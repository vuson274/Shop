...
<section>
    ...
    <span class="bg2"></span>
    <span class="bg2"></span>
    <div class="toast show" th:if="${message}" >
    ...
    <div class="login">
        ...
        <form th:action="@{/loginMember}" th:object="${user}" method="post">
            <div class="inputBox">
                <input type="email" id="email"  th:field="*{email}" placeholder="Email" name="email" required>
            </div>
            <div class="inputBox">
